...
function cards() {
    ...
    Object(_services_services__WEBPACK_IMPORTED_MODULE_0__["getResource"])('http://localhost:3333/menu')
        .then(data => {
...
function forms(formSelector, modalTimerId) {
    ...
    function bindPostData(form) {
        form.addEventListener('submit', (e) => {
            ...
            Object(_services_services__WEBPACK_IMPORTED_MODULE_1__["postData"])('http://localhost:3333/requests', json)
            .then(data => {
                console.log(data);
